  ...
  const fetchMedia = async () => {
    try {
      ...
      if (!data.success) {
        ...
        setError(data.message || 'Failed to fetch media item');
        setLoading(false);
        return;
      }
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (!uploadData.success) {
        ...
        setUploading(false);
        setPreviewUrl(formData.linkUrl || '');
        return;
      }
        ...
        <div className="container-fluid">
          <div className="card shadow-lg border-0">
            <div className="card-body p-4 text-center">
              ...
              <p className="mt-3 text-muted">Loading media item...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid">
        <div className="card shadow-lg border-0">
          <div className="card-header border-0 bg-theme-one p-3 d-flex justify-content-between align-items-center">
            <h1 className="h4 mb-0 text-white">Edit Media</h1>
          </div>
                    ...
                    <div className="mt-2">
                      ...
                      {uploadedFileData && (
                        <small className="text-success d-block mt-1">
                          <i className="fa fa-check-circle me-1"></i> {uploadedFileData.url ? 'New image uploaded' : 'Current image'}
                        </small>
                      )}
                    </div>
                  )}
              ...
              <div className="d-flex justify-content-end gap-2 pt-3 border-top">
                ...
                >
                  {saving ? (
                    ...
                    <>
                      <i className="fa fa-save me-2"></i> Update Media
                    </>
                  )}
                </button>
              </div>
