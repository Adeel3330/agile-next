                                    ...
                                    <div className="inner-box">
                                        ...
                                        <div className="lower-content">
                                            <div className="inner">
                                                ...
                                                <h3><Link href="/department-details">Cardiology</Link></h3>
                                    ...
                                    <div className="inner-box">
                                        ...
                                        <div className="lower-content">
                                            <div className="inner">
                                                ...
                                                <h3><Link href="/department-details-2">Dental</Link></h3>
                                                <p>Cardiologists are healthcare professionals.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="inner-box">
                                        ...
                                        <div className="lower-content">
                                            <div className="inner">
                                                ...
                                                <h3><Link href="/department-details-3">Gastroenterology</Link></h3>
                                                <p>Cardiologists are healthcare professionals.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="inner-box">
                                        ...
                                        <div className="lower-content">
                                            <div className="inner">
                                                ...
                                                <h3><Link href="/department-details-4">Neurology</Link></h3>
                                                <p>Cardiologists are healthcare professionals.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="inner-box">
                                        ...
                                        <div className="lower-content">
                                            <div className="inner">
                                                ...
                                                <h3><Link href="/department-details-5">Orthopaedics</Link></h3>
                                                <p>Cardiologists are healthcare professionals.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="inner-box">
                                        ...
                                        <div className="lower-content">
                                            <div className="inner">
                                                ...
                                                <h3><Link href="/department-details-6">Dental Caring</Link></h3>
                                                <p>Cardiologists are healthcare professionals.</p>
                                            </div>
                                        </div>
                                    </div>
